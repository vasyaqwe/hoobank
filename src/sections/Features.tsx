    ...
    return (
        <EvenColumns className="max-w-7xl px-7">
            <div className="grid gap-8">
                ...
                <Subtitle>With the right credit card, you can improve your financial life by building credit, earning rewards and saving money. But with hundreds of credit cards on the market.</Subtitle>
                <Button className="justify-self-start">
                    Get Started
                </Button>
            </div>
            <div className="grid lg:justify-end lg:place-content-center gap-3">
                {data.map((feature, idx) => <FeatureTestimonial key={idx} {...feature} />)}
            </div>
        </EvenColumns>
    )
}
