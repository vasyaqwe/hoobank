...
export const Quotes = () => {
    return (
        <section className="px-7 max-w-7xl mx-auto w-full relative">
            <div className="grid gap-4 mb-12 lg:grid-cols-[470px_1fr] lg:items-center lg:gap-28">
                <H2>What people are saying about us</H2>
                <Subtitle>Everything you need to accept card payments and grow your business anywhere on the planet.</Subtitle>
            </div>
            <div className="grid gap-2 lg:grid-cols-3">
                {data.map((quote, idx) => <QuoteTestimonial key={idx} {...quote} />)}
            </div>
            <GradientBlur className="bg-gradient-to-br
         from-secondary-700 to-accent-400 right-[-400px] top-0" />
        </section>
    )
}
